...
1. open doors - thread
2. taking of shirt - [Looper & Queue](#Looper-&-queue)
3. taking of trousers - [CPU operations basics Single-Tasking System](#CPU-Operations-basics)
4. lift the duvet up -  [Preemptive multitasking system](#Preemptive multitasking system)
5. fabrics on bedsheet - [Multiprocessing system](#Multiprocessing system) 
